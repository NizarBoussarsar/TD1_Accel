...
namespace TD1_Accel
{
    ...
    public sealed partial class App : Application
    {
        ...
        public static string DB_PATH = Path.Combine(Path.Combine(ApplicationData.Current.LocalFolder.Path, "AccelData2.sqlite"));//DataBase Name 
        ...
        public App()
        {
            ...
            if (!CheckFileExists("AccelData2.sqlite").Result)
            {
                using (var db = new SQLiteConnection(DB_PATH))
                {
                    db.CreateTable<AccelData>();
                }
            }
        }
